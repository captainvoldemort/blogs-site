...
export async function getPostBySlug(slug) {
  ...
  // Prepend basePath to relative src/href in rendered HTML so images,
  // videos, and links resolve correctly on GitHub Pages.
  const basePath = process.env.NEXT_PUBLIC_BASE_PATH || '';
  let contentHtml = processedContent.toString();
  if (basePath) {
    // Rewrite src="/..." and poster="/..." (but not src="http..." or src="//...")
