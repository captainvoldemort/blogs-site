...
export default function HomePage() {
  ...
  const pipeline = [
    ...
    },
    {
      ...
      title: 'Reconstruct',
      desc: 'Object-centric state via CAD model fitting',
    },
    {
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: 'Understand',
      desc: 'Infer state changes — pick, place, align, insert',
    },
    {
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: 'Compile',
      desc: 'Build a directed task graph with constraints',
    },
    {
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: 'Emit',
      desc: 'Output a structured recipe for humans or machines',
    },
  ];
  ...
  const useCases = [
    {
      ...
      desc: 'Capture and formalize manual assembly procedures as structured, reusable recipes.',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}
    ...
    },
    {
      ...
      desc: 'Compare procedures across operators to identify best practices and variations.',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}
    ...
    },
    {
      ...
      desc: 'Translate observed task graphs into executable robot skills and motion plans.',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}
    ...
    },
    {
      ...
      desc: 'Replay recorded procedures in simulation for validation and training.',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {useCases.map((uc, i) => (
              ...
              >
                ...
                <p className="text-xs text-zinc-500 leading-relaxed mb-4">{uc.desc}</p>
        ...
        <div className="max-w-3xl mx-auto px-6 text-center">
          <div className="bg-dark-card border border-dark-border rounded-2xl p-12 sm:p-16
            ...
            <div
              ...
              style={{
                backgroundImage:
                  'radial-gradient(circle at 50% 50%, #e8ff47 0%, transparent 60%)',
              }}
            />
