...
export function generateMetadata({ params }) {
  ...
  return {
    title: `${author.name} — BlogSite`,
    description: author.bio,
  };
}

/**
 * Author profile page — shows author info and their blog posts.
 */
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
      ...
      <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 mb-12 pb-12 
        ...
        {/* Avatar */}
        <div className="w-24 h-24 rounded-full overflow-hidden bg-gradient-to-br from-primary-100 
                        to-primary-200 ring-4 ring-white shadow-lg flex-shrink-0">
          {avatarSrc ? (
